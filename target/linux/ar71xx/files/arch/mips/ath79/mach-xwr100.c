...
#define XWR100_GPIO_LED_USB_WHITE  	0
#define XWR100_GPIO_LED_POWER_WHITE	1
#define XWR100_GPIO_LED_WPS_WHITE  	5
#define XWR100_GPIO_LED_WLAN_WHITE 	6
...
static struct gpio_led xwr100_leds_gpio[] __initdata = {
	{
		...
		.gpio		= XWR100_GPIO_LED_USB_WHITE,
		.active_low	= 1,
	}, {
		.name		= "xwr100:white:power",
		.gpio		= XWR100_GPIO_LED_POWER_WHITE,
		.active_low	= 0,
		.default_trigger = "default-on",
	}, {
		.name		= "xwr100:white:wps",
		.gpio		= XWR100_GPIO_LED_WPS_WHITE,
		.active_low	= 1,
	}, {
		.name		= "xwr100:white:wlan",
		.gpio		= XWR100_GPIO_LED_WLAN_WHITE,
		.active_low	= 1,
	}
};
